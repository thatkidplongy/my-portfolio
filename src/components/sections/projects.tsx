...
const Projects = () => {
  const projects: Project[] = [
    {
      id: "1",
      title: "Before You Buy Website",
      description: "A one-stop shop for all your property reports",
    ...
    {
      id: "2",
      title: "Before You Buy Backyard",
      description: "Admin Dashboard for Before You Buy",
      image: "/backyard.png",
      techStack: [
        "React - Vite",
        "TypeScript",
